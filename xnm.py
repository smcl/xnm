...
def addModemConnection(container, connId, connected, dev, connection):
    ...
    b = Button(f, text=" " + connId, bg=bgColor, fg=fgColor, font=bodyFont, justify=LEFT, anchor=W, command=callback, highlightthickness=0, relief=FLAT, activeforeground=bgColor, activebackground=fgColor)
...
def addWifiConnection(container, ap, connected=False, saved=None, protected=False, dev=None):
    ...
    b = Button(f, text=" " + ap.Ssid, bg=bgColor, fg=fgColor, font=bodyFont, justify=LEFT, anchor=W, command=callback, highlightthickness=0, relief=FLAT, activeforeground=bgColor, activebackground=fgColor)
    b.grid(row=0, column = 3, sticky="ew")
